...
\par
	...
	Ennek a gombnak a segítségével a jelenlegi eszközöknek a beállításait mentheti el a felhasználó, amennyiben számára az eszközök elérhetőek. A funkció kifejtését és a megoldását a későbbiekben, a Form Mentés %ide kéne egy cite a kövi alfejezetre
	...
	%ide kéne egy cite a kövi alfejezetre
	...
	alfejezetben fejtem ki.
	\\
	A Kilépés gombot arra használhatja a felhasználó
